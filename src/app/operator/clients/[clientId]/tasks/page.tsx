...
export default async function OperatorClientTasksPage({ params }: { params: { clientId: string } }) {
  const user = await requireOperator();
  const { client, tasks } = await getClientWorkspaceForOperator(params.clientId);
