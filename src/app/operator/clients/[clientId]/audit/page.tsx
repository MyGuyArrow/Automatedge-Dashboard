...
export default async function OperatorClientAuditPage({ params }: { params: { clientId: string } }) {
  const user = await requireOperator();
  const { client, auditScores } = await getClientWorkspaceForOperator(params.clientId);
