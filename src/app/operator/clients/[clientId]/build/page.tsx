...
export default async function OperatorClientBuildPage({ params }: { params: { clientId: string } }) {
  const user = await requireOperator();
  const { client, buildPhases } = await getClientWorkspaceForOperator(params.clientId);
