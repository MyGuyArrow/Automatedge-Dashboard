...
export default async function OperatorClientAccessPage({ params }: { params: { clientId: string } }) {
  const user = await requireOperator();
  const { client, accessRequests } = await getClientWorkspaceForOperator(params.clientId);
