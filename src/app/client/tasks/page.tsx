  ...
  return (
    <AppShell user={user}>
      <section className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        <h1 className="text-2xl font-semibold text-slate-950">Client Action Centre</h1>
        <div className="mt-6 space-y-3">
          ...
          {!summary.requiredActions.length ? <p className="text-sm text-slate-600">No open client tasks.</p> : null}
        </div>
      </section>
    </AppShell>
  );
